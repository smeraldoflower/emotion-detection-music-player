...
#    button = tk.Button(root, text="Quit", command=quit_gui)
#    button.pack()
...
def FER_live_cam():
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            try:
                new , buffer =cv2.imencode(".jpg", cv2.flip(frame,1))
...
def video_feed():
    ...
    return Response(FER_live_cam(), mimetype='multipart/x-mixed-replace; boundary=frame')
